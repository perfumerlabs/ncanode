...
return [
    'error.cms_or_xml_required' => 'CMS or XML parameter must be set',
    'error.only_cms_or_xml_required' => 'Only one of CMS or XML parameter must be set',
    'error.rules_invalid' => 'Rule parameter must be one of',
    'error.certificate_not_legal' => 'Certificate is not legal',
