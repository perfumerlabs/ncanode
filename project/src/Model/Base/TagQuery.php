...
/**
 * Base class that represents a query for the 'ncanode_tag' table.
 *
 *
 *
 ...
 *
 * @method     ChildTagQuery leftJoinSignatureTag($relationAlias = null) Adds a LEFT JOIN clause to the query using the SignatureTag relation
 * @method     ChildTagQuery rightJoinSignatureTag($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SignatureTag relation
 * @method     ChildTagQuery innerJoinSignatureTag($relationAlias = null) Adds a INNER JOIN clause to the query using the SignatureTag relation
 *
 * @method     ChildTagQuery joinWithSignatureTag($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SignatureTag relation
 *
 * @method     ChildTagQuery leftJoinWithSignatureTag() Adds a LEFT JOIN clause and with to the query using the SignatureTag relation
 * @method     ChildTagQuery rightJoinWithSignatureTag() Adds a RIGHT JOIN clause and with to the query using the SignatureTag relation
 * @method     ChildTagQuery innerJoinWithSignatureTag() Adds a INNER JOIN clause and with to the query using the SignatureTag relation
 *
 * @method     \Ncanode\Model\SignatureTagQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildTag|null findOneByCode(string $code) Return the first ChildTag filtered by the code column
 * @method     ChildTag|null findOneByCreatedAt(string $created_at) Return the first ChildTag filtered by the created_at column
 * @method     ChildTag|null findOneByUpdatedAt(string $updated_at) Return the first ChildTag filtered by the updated_at column *
...
abstract class TagQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Ncanode\Model\Base\TagQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'ncanode', $modelName = '\\Ncanode\\Model\\Tag', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, code, created_at, updated_at FROM ncanode_tag WHERE id = :p0';
        try {
    ...
    public function filterBySignatureTag($signatureTag, $comparison = null)
    {
        if ($signatureTag instanceof \Ncanode\Model\SignatureTag) {
            return $this
                ->addUsingAlias(TagTableMap::COL_ID, $signatureTag->getTagId(), $comparison);
