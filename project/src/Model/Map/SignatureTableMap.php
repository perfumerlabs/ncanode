...
class SignatureTableMap extends TableMap
{
     ...
     */
    const COL_CODE = 'ncanode_signature.code';
     ...
     */
    const COL_TAGS = 'ncanode_signature.tags';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Code', 'ParentId', 'Signature', 'Tags', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'code', 'parentId', 'signature', 'tags', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SignatureTableMap::COL_ID, SignatureTableMap::COL_CODE, SignatureTableMap::COL_PARENT_ID, SignatureTableMap::COL_SIGNATURE, SignatureTableMap::COL_TAGS, SignatureTableMap::COL_CREATED_AT, SignatureTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'code', 'parent_id', 'signature', 'tags', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Code' => 1, 'ParentId' => 2, 'Signature' => 3, 'Tags' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'code' => 1, 'parentId' => 2, 'signature' => 3, 'tags' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SignatureTableMap::COL_ID => 0, SignatureTableMap::COL_CODE => 1, SignatureTableMap::COL_PARENT_ID => 2, SignatureTableMap::COL_SIGNATURE => 3, SignatureTableMap::COL_TAGS => 4, SignatureTableMap::COL_CREATED_AT => 5, SignatureTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'code' => 1, 'parent_id' => 2, 'signature' => 3, 'tags' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'code' => 'CODE',
        'signature.code' => 'CODE',
        'SignatureTableMap::COL_CODE' => 'CODE',
        'COL_CODE' => 'CODE',
        'code' => 'CODE',
        'ncanode_signature.code' => 'CODE',
        'ParentId' => 'PARENT_ID',
        ...
        'tags' => 'TAGS',
        'signature.tags' => 'TAGS',
        'SignatureTableMap::COL_TAGS' => 'TAGS',
        'COL_TAGS' => 'TAGS',
        'tags' => 'TAGS',
        'ncanode_signature.tags' => 'TAGS',
